#!/usr/bin/env python3
"""
Script de Pruebas Flexible para Lexical Analyzer
===============================================

Este script te permite probar fácilmente diferentes expresiones regulares
simplemente modificando las variables al inicio del archivo.

Uso:
1. Modifica las variables REGEX y TEST_WORDS al inicio del archivo
2. Ejecuta: python test_lexical.py
...
# Expresión regular a probar - Patrón específico para las palabras de prueba
REGEX = r"\?(((.|eps)?!?)\*)+"
...
def run_tests():
    ...
    print("=" * 80)
    print("LEXICAL ANALYZER - SCRIPT DE PRUEBAS")
    print("=" * 80)
